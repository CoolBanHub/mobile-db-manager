export default {
  ...
  sqlLibrary: {
    ...
    prev: "Previous",
    next: "Next",
    searchFailed: "Failed to search saved SQL: {message}",
  },
  ...
  objects: {
    ...
    sortDesc: "Descending",
    sortBy: "Sort by",
    refreshMetadata: "Refresh metadata for this object",
    metadataLoading: "Loading",
    metadataCached: "Cached · {age}",
    metadataRefreshed: "Refreshed now",
    metadataLive: "Live",
    metadataNotLoaded: "Not loaded",
    metadataJustNow: "just now",
    metadataSeconds: "{count}s ago",
    metadataMinutes: "{count}m ago",
    includedColumns: "Included",
    allSchemas: "All schemas",
    partialSchemaLoadFailed: "Metadata failed to load for {count} schemas; showing the remaining results",
  },
  structureEditor: {
