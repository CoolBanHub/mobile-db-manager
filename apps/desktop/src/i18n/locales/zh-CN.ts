...
export default withEnglishFallback({
  ...
  sqlLibrary: {
    ...
    prev: "上一页",
    next: "下一页",
    searchFailed: "搜索保存 SQL 失败：{message}",
  },
  ...
  objects: {
    ...
    sortDesc: "降序",
    sortBy: "排序方式",
    refreshMetadata: "刷新当前对象元数据",
    metadataLoading: "加载中",
    metadataCached: "缓存 · {age}",
    metadataRefreshed: "刚刚已刷新",
    metadataLive: "实时",
    metadataNotLoaded: "未加载",
    metadataJustNow: "刚刚",
    metadataSeconds: "{count} 秒前",
    metadataMinutes: "{count} 分钟前",
    includedColumns: "包含列",
    allSchemas: "全部 Schema",
    partialSchemaLoadFailed: "{count} 个 Schema 的元数据加载失败，已显示其余结果",
  },
  structureEditor: {
    title: "编辑表结构",
    createTitle: "新建表",
